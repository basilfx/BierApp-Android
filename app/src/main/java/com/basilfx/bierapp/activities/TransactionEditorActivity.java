...
import com.basilfx.bierapp.data.adapters.TransactionItemEditorListAdapter;
...
import com.basilfx.bierapp.views.TransactionItemView;
import com.basilfx.bierapp.views.TransactionItemView.OnTransactionItemListener;
...
public class TransactionEditorActivity extends OrmLiteBaseActivity<DatabaseHelper> implements OnMenuItemClickListener, OnTransactionItemListener, OnSaveActionListener {
	...
	public static final String ACTION_UNDO_TRANSACTION = "com.basilfx.bierapp.ACTION_UNDO_TRANSACTION";
	public static final String ACTION_ADD_TEMPLATE_TRANSACTION = "com.basilfx.bierapp.ACTION_ADD_TEMPLATE_TRANSACTION";
	public static final String ACTION_ADD_NORMAL_TRANSACTION = "com.basilfx.bierapp.ACTION_ADD_NORMAL_TRANSACTION";
	...
	public void onBackPressed() {
		if (this.transactionItems.size() > 0) {
